...
const Categories = () => {
  ...
  return (
    <div className="w-[100%] medium:w-[100%]  mt-[35px] small:mb-[50px] sticky top-[100px] medium:hidden">
        {/* main */}
        <div className="border-[#e4e2e2] border-b-[1px]">
            ...
            <div className="w-[100%] medium:w-[100%] flex flex-wrap my-[10px]">
                {data.map((el: any) => {
                    return <div className="bg-[#f2f2f2] py-[10px] px-[15px] rounded-[20px] flex text-[14px] mt-[10px] mr-[10px] hover:bg-[#d8d7d7] transition-all duration-500 small:text-[12px] small:py-[8px] small:px-[8px]
