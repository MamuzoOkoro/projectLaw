...
const Categories = () => {
  ...
  return (
    <div className="w-[90%] medium:w-[100%] h-[400px]  mt-[35px] medium:mb-[-100px] small:mb-[50px] sticky top-[100px] ">
        {/* main */}
        ...
        {/* main */}
        <div className="flex flex-wrap my-[20px] text-[14px] text-[grey] medium:w-[90%] medium:my-[5px] small:my-[10]">
        {newData.map((el: any) => {
